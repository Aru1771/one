...
<body>
	...
	<h1 style="color: pink; font-size: 40px;" align="center">i am aravind kaki</h1>
	<h1 style="color: grey; font-size: 40px;" align="center">i am devops engg</h1>
	...
	<h1 style="color: black; font-size: 40px;" align="center">we are done with nexus also</h1>
         <h1 style="color: black; font-size: 40px;" align="center">bad ass maaaaaa</h1>
